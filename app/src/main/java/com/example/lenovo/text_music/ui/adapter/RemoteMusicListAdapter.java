...
public class RemoteMusicListAdapter extends RecyclerView.Adapter<RemoteMusicListAdapter.MyViewHolder> {

    private Context context;
    //数据源
    private ArrayList<RemoteMusicListBean.SongListBean> list;
    //点击事件回调接口
     ...
     * @param list 数据源
     */
    public RemoteMusicListAdapter(Context context, ArrayList<RemoteMusicListBean.SongListBean> list) {
